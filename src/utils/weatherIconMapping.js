 ...
 * @param {boolean} isNight - Whether it's nighttime (default: false)
 * @returns {string} Meteocons icon name (e.g., "sleet", "partly-cloudy-day-rain")
 */
 ...
 *
 * @param {string} periodName - NOAA period name (e.g., "Tonight", "Monday Night")
 * @returns {boolean}
 */
